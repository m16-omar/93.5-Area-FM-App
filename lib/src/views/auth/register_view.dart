                    ...
                    children: [
                      Expanded(
                        child: _SocialButton(
                          ...
                          onTap: () {
                            SnackbarHelper.showSuccess(context, 'Google Sign-Up coming soon');
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: _SocialButton(
                          ...
                          onTap: () {
                            SnackbarHelper.showSuccess(context, 'Apple Sign-Up coming soon');
                          },
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: _SocialButton(
                          ...
                          onTap: () {
                            SnackbarHelper.showSuccess(context, 'Facebook Sign-Up coming soon');
                          },
                        ),
                      ),
                    ],
